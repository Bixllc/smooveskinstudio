...
export function ServiceSelection({ clientSlug, categoryName, services }: ServiceSelectionProps) {
      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        <div className="grid grid-cols-4 gap-6 items-start">
          ...
          <div className="col-span-2">
            <Link
              href={`/${clientSlug}`}
              className="mb-4 inline-flex items-center gap-1 text-sm font-medium text-[var(--color-primary)] hover:text-[var(--color-primary-dark)] transition-colors"
            >
              &lsaquo; Back to Categories
            </Link>
            <h2 className="text-xl font-bold text-[var(--color-text)]">Select a Service</h2>
            <p className="mt-1 mb-5 text-sm text-[var(--color-text-light)]">
              {categoryName} — choose from our premium services
            </p>
          ...
          <div className="col-span-1">
            <div className="rounded-xl border border-[var(--color-border)] bg-white p-5">
              <h3 className="font-semibold text-[var(--color-text)]">Booking Summary</h3>
