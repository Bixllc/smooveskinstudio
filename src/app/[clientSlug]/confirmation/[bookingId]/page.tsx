...
async function verifyAndConfirmPayment(paymentIntentId: string, bookingId: string) {
  try {
    ...
    // Payment verification failed — booking stays PENDING_PAYMENT
  }
}
...
export default async function ConfirmationPage({
  ...
  // Verify Stripe payment if redirected from Stripe
    ...
    <div>
      ...
      <div className="px-4 py-10">
        <div className="mx-auto max-w-xl">
          ...
          <div className="mb-8 flex flex-col items-center text-center">
            <div className="mb-5 flex h-20 w-20 items-center justify-center rounded-full bg-[#faf7f2] ring-8 ring-[#C9A96E]/15">
              <svg
                ...
                className="animate-[checkIn_0.4s_ease-out_forwards]"
                style={{ opacity: 1 }}
              >
          ...
          {/* Calendar actions (client component for iCal download) */}
          <CalendarActions
            gcalUrl={gcalUrl}
