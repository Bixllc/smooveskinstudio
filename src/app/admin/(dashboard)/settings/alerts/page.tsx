  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden">
      <div className="flex h-11 flex-shrink-0 items-center gap-2 border-b border-[#e8e6e1] bg-white px-4">
        ...
        <span className="text-sm font-medium text-[#1a1814]">Booking Alerts</span>
      </div>
  ...
  return (
    <div className="flex items-start justify-between gap-4">
      ...
      <button
        ...
        className={`relative mt-0.5 h-5 w-9 flex-shrink-0 rounded-full transition-colors ${checked ? "bg-[#C9A96E]" : "bg-[#e8e6e1]"}`}
      >
        <span
